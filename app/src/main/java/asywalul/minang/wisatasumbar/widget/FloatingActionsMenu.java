...
public class FloatingActionsMenu extends ViewGroup{
    ...
    private FrameLayout mFrameLayoutWrapper;
    ...
    private void init(Context context, AttributeSet attributeSet) {
        ...
        mAddButtonPlusColor = attr.getColor(R.styleable.FloatingActionsMenu_fab_addButtonPlusIconColor, getColor(android.R.color.holo_blue_bright));
        mAddButtonColorNormal = attr.getColor(R.styleable.FloatingActionsMenu_fab_addButtonColorNormal, getColor(android.R.color.holo_blue_dark));
        mAddButtonColorPressed = attr.getColor(R.styleable.FloatingActionsMenu_fab_addButtonColorPressed, getColor(android.R.color.holo_purple));
        mAddButtonSize = attr.getInt(R.styleable.FloatingActionsMenu_fab_addButtonSize, FloatingActionButton1.SIZE_NORMAL);
    ...
    public void addButton(FloatingActionButton1 button) {
    ...
    public void removeButton(FloatingActionButton1 button) {
    ...
    private void createLabels() {
        ...
        for (int i = 0; i < mButtonsCount; i++) {
            FloatingActionButton1 button = (FloatingActionButton1) getChildAt(i);
