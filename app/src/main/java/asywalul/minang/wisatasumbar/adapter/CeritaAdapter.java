...
public class CeritaAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View itemView, ViewGroup parent) {
        ...
        if (itemView == null) {
            ...
            holder.ivCerita    = (SimpleDraweeView) itemView.findViewById(R.id.iv_cerita);
        ...
        Uri uri = Uri.parse(cerita.image);
        holder.ivCerita.setImageURI(uri);
    ...
    static class ViewHolder {
        ...
        private SimpleDraweeView ivCerita;
