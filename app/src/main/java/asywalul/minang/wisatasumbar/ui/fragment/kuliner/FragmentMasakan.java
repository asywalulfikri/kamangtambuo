 ...
 */
public class FragmentMasakan extends BaseListFragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private String category= "masakan";
    private AppBarLayout appBarLayout;

    public static FragmentMasakan newInstance() {
