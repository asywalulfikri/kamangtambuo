...
import asywalul.minang.wisatasumbar.adapter.KulinerAdapter;
import asywalul.minang.wisatasumbar.http.KulinerConnection;
 ...
 */
public class KulinerFragment extends BaseListFragment implements KulinerAdapter.OnItemClickListener {
    private RecyclerView mRecyclerView;
    private LoadingLayout mLoadingLayout;
    private KulinerAdapter mAdapter;
    private KulinerWrapper wrapper;
    private ArrayList<Kuliner> mKulinerList = new ArrayList<Kuliner>();
    private int mPage = 1;
...
//    }
    ...
    private void updateView(KulinerWrapper wrapper) {
//        rlLoadMore.setVisibility(View.VISIBLE);
        progressBar.setVisibility(View.GONE);
        tvLoadMore.setText(getString(R.string.text_next));

        Log.e("DDD", "DISINI");
        mAdapter = new KulinerAdapter(getActivity());
...
//        mAdapter.setFooterView(footerView);
    ...
    private void loadMoreView (KulinerWrapper wrapper) {
    ...
    public void onItemClick(View view, int position) {
        Kuliner kuliner = mKulinerList.get(position);
...
//            showLoading();
        ...
        protected Long doInBackground(URL... urls) {
            ...
            try {
                ...
                KulinerConnection conn = new KulinerConnection();
...
//                                loadMoreView(wrapper);
                            ...
                            Log.e("DDD", "DISINI4");
                            mKulinerList = new ArrayList<Kuliner>();
                            updateView(wrapper);

                        }
                        for (int i = 0; i < wrapper.list.size(); i++) {
                            mKulinerList.add(wrapper.list.get(i));
                        }
//                            mPage = mPage + 1;
                        showList();
