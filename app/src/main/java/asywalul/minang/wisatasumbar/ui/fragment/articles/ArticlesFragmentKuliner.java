 ...
 */
public class ArticlesFragmentKuliner extends BaseListFragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public static ArticlesFragmentKuliner newInstance() {
        return new ArticlesFragmentKuliner();
    }
    ...
    public class LoadCacheTask extends AsyncTask<URL, Integer, Long> {
        ...
        protected Long doInBackground(URL... urls) {
            ...
            try {
                ...
                wrapper = mCacheDb.getListArticles("articles-kuliner");
                result = 1;
            } catch (Exception e) {
                e.printStackTrace();
            }
...
//                showFormField();
    ...
    public void loadTask2() {
        startCountTime();
        page = 1;
        url = Cons.CONVERSATION_URL +"/listArticlesKategori.php?category=kuliner&&page="+page +"&count=20"+urutan ;
        Log.d("urlnya", url);
                        ...
                        try {
                            ...
                            if (wrapper != null) {
                                if (wrapper.list.size() == 0) {
                                    ...
                                    updateList(wrapper);
                                    mCacheDb.updateArticlesList(wrapper.list,"articles-kuliner");
                                }
                            } else {
                                showEmpty(getString(R.string.text_no_data));
                            }
    ...
    public void loadTask3() {
        startCountTime();
        page += 1;
        String url = Cons.CONVERSATION_URL +"/listArticlesKategori.php?category=kuliner&&page="+page +"&count=20"+urutan ;
        Log.d("urlnya", url);
        StringRequest mRequest = new StringRequest(Request.Method.GET, url,
                new Response.Listener<String>() {
                    @Override
