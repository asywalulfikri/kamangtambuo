 ...
 */
public class AngkutanPariwisata extends BaseListFragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public static AngkutanPariwisata newInstance() {
        return new AngkutanPariwisata();
    }
