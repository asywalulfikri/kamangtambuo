 ...
 */
public class AngkutanKapal extends BaseListFragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private String type = "AK";


    public static AngkutanKapal newInstance() {
        return new AngkutanKapal();
    }
