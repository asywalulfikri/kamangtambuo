...
/**
 * Created by MacbookPro  Asywalul Fikri on 3/12/2016.
 */
public class FragmentPenganan extends BaseListFragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private String category= "penganan";
    private AppBarLayout appBarLayout;

    public static FragmentPenganan newInstance() {
        return new FragmentPenganan();
    }
