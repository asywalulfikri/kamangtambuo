 ...
 */
public class ListWisataPerKabupaten extends BaseListActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        user = getUser();
        intent = getIntent();
        kabupaten = intent.getStringExtra("kabupaten");
    ...
    public class LoadCacheTask extends AsyncTask<URL, Integer, Long> {
        ...
        protected Long doInBackground(URL... urls) {
            ...
            try {
                ...
                wrapper = mCacheDb.getListWisata("wisata-"+kabupaten);
                Debug.i("Checking cache " + "wisata-" + kabupaten);
                result = 1;
            } catch (Exception e) {
                e.printStackTrace();
            }
